...
import com.fourtk.shoppingapi.services.exceptions.DataBaseException;
import com.fourtk.shoppingapi.services.exceptions.ResourcesNotFoundException;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> databaseReplicated(NotReadablePropertyException e, HttpServletRequest request){

        HttpStatus status = HttpStatus.BAD_REQUEST;
        StandardError err =  new StandardError();
        err.setTimestamp(Instant.now());
        err.setStatus(status.value());
        err.setError("CPF Is Exists!");
        err.setMessage(e.getMessage());
        err.setPath(request.getRequestURI());
